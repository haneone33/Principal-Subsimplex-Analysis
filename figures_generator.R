...
ggsave('PCA_failure.jpeg', g, path = 'Figures', width = 5.5, height = 5)
...
g1 = ggtern(X, aes(x=V1,y=V3,z=V2)) +
  ...
  theme_bw()
ggsave('Log-ratio PCA1.jpeg', g1, path = 'Figures', width = 4, height = 4)
...
ggsave('Log-ratio PCA2.jpeg', g2, path = 'Figures', width = 4, height = 4)
...
g3 = ggtern(X, aes(x=V1,y=V3,z=V2)) +
  ...
  theme_bw()
g3
ggsave('Log-ratio PCA3.jpeg', g3, path = 'Figures', width = 4, height = 4)
